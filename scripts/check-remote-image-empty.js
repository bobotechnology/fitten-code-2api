...
fixtureServer.listen(3033, '127.0.0.1', () => {
    ...
    try {
        ...
        messages: [
          {
            role: 'user',
            content: [
              { type: 'input_image', image_url: 'http://127.0.0.1:3033/empty.png' },
      ...
      finish(0, {
        ...
        rejected_as_expected:
          response.status === 400 &&
          parsed?.error?.code === 'remote_image_empty' &&
